...
###Go ahead and play around with this a little bit. Then I have an excercise for you.
  ...
  - create a rectangle that starts on coordinates (100, 100) with height of 200, and in the place of the width parameter put 'sizeXVar'
  - like this:
  ```
  rect(100, 100, sizeXVar, 200)
  ```
